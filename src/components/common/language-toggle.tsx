    ...
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <Button variant="outline">
          <span className="text-lg uppercase">{lang}</span>
          <span className="sr-only">Toggle language</span>
        </Button>
      </DropdownMenuTrigger>
      <DropdownMenuContent align="end">
        <DropdownMenuItem onClick={() => handleRedirect("es")}>
          <div className="flex w-full gap-3 cursor-pointer">
            <div className="size-5">
              <svg className="w-full h-full" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 36 36" aria-hidden="true" role="img" class="iconify iconify--twemoji" preserveAspectRatio="xMidYMid meet"><path fill="#FBD116" d="M32 5H4a4 4 0 0 0-4 4v9h36V9a4 4 0 0 0-4-4z" /><path fill="#22408C" d="M0 18h36v7H0z" /><path fill="#CE2028" d="M0 27a4 4 0 0 0 4 4h28a4 4 0 0 0 4-4v-2H0v2z" /></svg>
            </div>
            <p>Español</p>
          </div>
        </DropdownMenuItem>
        <DropdownMenuItem onClick={() => handleRedirect("en")}>
          <div className="flex w-full gap-3 cursor-pointer">
            <div className="size-5">
              <svg className="w-full h-full" xmlns="http://www.w3.org/2000/svg" viewBox="0 -4 28 28" fill="none">
        ...
        <DropdownMenuItem onClick={() => handleRedirect("pt-br")}>
          <div className="flex gap-3 cursor-pointer">
            <div className="size-5">
              <svg className="w-full h-full" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 36 36" aria-hidden="true" role="img" class="iconify iconify--twemoji" preserveAspectRatio="xMidYMid meet"><path fill="#009B3A" d="M36 27a4 4 0 0 1-4 4H4a4 4 0 0 1-4-4V9a4 4 0 0 1 4-4h28a4 4 0 0 1 4 4v18z" /><path fill="#FEDF01" d="M32.728 18L18 29.124L3.272 18L18 6.875z" /><circle fill="#002776" cx="17.976" cy="17.924" r="6.458" /><path fill="#CBE9D4" d="M12.277 14.887a6.406 6.406 0 0 0-.672 2.023c3.995-.29 9.417 1.891 11.744 4.595c.402-.604.7-1.28.883-2.004c-2.872-2.808-7.917-4.63-11.955-4.614z" /><path fill="#88C9F9" d="M12 18.233h1v1h-1zm1 2h1v1h-1z" /><path fill="#55ACEE" d="M15 18.233h1v1h-1zm2 1h1v1h-1zm4 2h1v1h-1zm-3 1h1v1h-1zm3-6h1v1h-1z" /><path fill="#3B88C3" d="M19 20.233h1v1h-1z" /></svg>
            </div>
            <p>Português</p>
          </div>
        </DropdownMenuItem>
